        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-start pt-8">
          ...
          <div ref={leftColRef} className="lg:col-span-5 flex flex-col gap-10">
            ...
            <div>
              ...
              >
                Let&apos;s build the
                <br /> future of lending
                <br /> together.
              </h1>
              <p className="text-lg text-slate-600 font-light max-w-[420px] leading-snug">
                Questions about integrations, pricing, or custom workflows? Our
                team replies in under 15 minutes.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="group bg-white border border-slate-200/70 hover:border-[#131c33]/30 p-5 rounded-3xl transition-all duration-300 hover:shadow-lg">
                <div className="flex items-start gap-5">
                  ...
                  <div className="flex-1">
                    <div className="text-[10px] font-mono uppercase tracking-[1px] text-slate-400 mb-1">
                      CUSTOMER CARE
                    </div>
                    <a
                      href="tel:+917792077777"
                      className="text-[#131c33] font-semibold hover:text-[#2b7fff] transition-colors block"
                    >
                      +91 7792077777
                    </a>
              ...
              >
                ...
                <div>
                  <div className="text-[10px] font-mono uppercase tracking-[1px] text-slate-400 mb-px">
                    EMAIL US
                  </div>
                  <div className="text-[#131c33] font-semibold group-hover:text-[#2b7fff] transition-colors">
                    utkarsh@maitriiinfotech.com
                  </div>
                </div>
              </a>
              ...
              {isSubmitted ? (
                ...
                <div className="py-14 flex flex-col items-center justify-center text-center relative z-10">
                  ...
                  <p className="text-slate-600 max-w-[320px] leading-relaxed mb-10 text-[15px]">
                    Our team will get back to you within 24 hours (Monday
                ...
                >
                  <div className="mb-1">
                    <div className="inline-block text-[10px] font-bold uppercase tracking-[2px] text-[#131c33]/60 mb-3">
                      15-MINUTE CALLBACK
                    </div>
                    <h2
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-[10px] font-semibold uppercase tracking-widest text-slate-500 mb-2"
                      >
                        Full Name
                      </label>
                      <input
                  ...
                  <p className="text-center text-[10px] text-slate-400 tracking-wider mt-1">
